...
class SuggestionBloc extends Bloc<SuggestionEvent, SuggestionState> {
  ...
  SuggestionBloc(this.getSuggestions) : super(const SuggestionState()) {
  ...
  Future<void> _onFetched(
    ...
    try {
      if (state.status == SuggestionStatus.initial) {
        emit(state.copyWith(status: SuggestionStatus.loading));

        final suggestions = await getSuggestions(page: _page, limit: _limit);
      ...
      emit(state.copyWith(status: SuggestionStatus.failure));
    }
  }
}
